...
compliments = [
    {
        ...
        "level": 5,     # Level of absurdity from 1 to 10 where 1 is the least absurd to 10 is the most absurd
    ...
    {
        "compliment": "You are so big brain that your brain must always be thinking of O(log n)",
        "category": categories[0],
        "level": 4,
        "short": "false"
    },
    {
        "compliment": "That outfit suits you so much that I think you should wear it every single day.",
        "category": categories[1],
        "level": 2,
        "short": "false"
    },
    ...
    for comp in compliments:
        ...
        if level != None:
            if level < 1 or level > 5:
                abort(404, description="Invalid level. Level must be between 1 and 6 inclusive")
            if comp["level"] != level:
